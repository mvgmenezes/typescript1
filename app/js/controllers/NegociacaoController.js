class NegociacaoController {
    ...
    adiciona(event) {
        ...
        const negociacao = new Negociacao(new Date(this._inputData.val().replace(/-/g, ',')), //troca todas as posicoes (/-/g) de -, pois vem no formato 2011-12-01 e coloco como 2011,12,01 pois o new Date entende esse padrao.
        parseInt(this._inputQuantidade.val()), parseFloat(this._inputValor.val()));
